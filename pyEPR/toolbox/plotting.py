...
def get_color_cycle(n, colormap=None, start=0.0, stop=1.0, format="hex"):
    """
...
def cmap_discrete(n, cmap_kw={}):
    ...
    cmap_KW = dict(colormap=default_colormap(), start=0.05, stop=0.95)
...
def cmap_discrete_CubeHelix(n, helix_kw={}):
    ...
    Requires palettable
    """
    from palettable import cubehelix  # pylint: disable=E0401
