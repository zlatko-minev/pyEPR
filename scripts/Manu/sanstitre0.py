...
file_list=getfiles_h5(r'C:\GitHub\pyEPR\scripts\Manu\GD_descent_run01092020','summary.npy')
...
for file in file_list:
    summary=np.load('C:\GitHub\pyEPR\scripts\Manu\GD_descent_run01092020\\'+file)[()]
