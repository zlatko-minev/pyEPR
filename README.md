...
* pyHFSS and pyNumericalDiagonalization were contributed by Phil Rheinhold. For his excellent original pyHFSS interface between python and HFSS, see [pyHFSS](https://github.com/PhilReinhold/pyHFSS)
